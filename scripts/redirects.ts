...
[[redirects]]
from = "${base}pdf"
to = "https://github.com/kirklin/talks/blob/main/${dir}/${pdfFile}?raw=true"
status = 302
...
[[redirects]]
from = "${base}src"
to = "https://github.com/kirklin/talks/tree/main/${dir}"
status = 302`);

    parts.push(`
[[redirects]]
from = "${dir}"
to = "https://talks.kirklin.cn${base}"
status = 301
